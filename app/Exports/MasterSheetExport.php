...
class MasterSheetExport extends DefaultValueBinder implements ShouldAutoSize, WithStyles, WithCustomStartCell,  FromCollection, Responsable, WithHeadings, WithMapping, WithCustomValueBinder
{
    use Exportable;
     ...
     */
    private $fileName = 'master-sheet.xlsx';
    private $title = 'Hoja Master';
