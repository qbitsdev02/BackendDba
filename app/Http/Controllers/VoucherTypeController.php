...
class VoucherTypeController extends Controller
{
    ...
    */
    ...
    {
        $voucherTypes = VoucherType::filters($request->all())->search($request->all());
    ...
    */
    ...
    {
        return response()->json($voucherType, 200);
    }
    ...
    public function update(Request $request, VoucherType $voucherType)
    {
        $voucherType->name = $request->name;
        $voucherType->description = $request->description;
        $voucherType->user_updated_id = $request->user_updated_id;
        $voucherType->update();
        return response()->json($voucherType, 200);
    }
    /**
